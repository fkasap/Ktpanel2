...
- ℹ **beta referansı: XKTUM (BIST resmî arşiv)** (197 gün)
...
### TEFAS genel bilgi (§253i) — ✓ 2034 fon · AUM + yatırımcı sayısı köprüden (ham 2041 kayıt, sayfalamalı)

### TEFAS köprü (bilgi)
- getiri: 1063 fon ✓ · liste: 1054 kayıt · alanlar: fonKod, unvan, kurucuKod, kurucuAd, oprKod, oprAd, durum, tarih

### Fon akışı — ℹ 973 fonun kurucusu fon adından türetildi (§279; mod=liste 1054 kayıt kapsıyordu, evren 2034)
...
- çıkış: AZİMUT -5.86 mlr · YAPI KREDİ -6.22 mlr · PUSULA -16.65 mlr

### Fon akışı (§263) — ✓ 2034 fon · 2026-09-04 → 2026-09-07
- giriş 97.71 mlr ₺ · çıkış -97.21 mlr ₺ · net 0.50 mlr ₺

### TEFAS çekim tanısı (bilgi)
- yol: vercel-köprüsü (2034 fon fiyat + 1063 getiri)
- yakalanan JSON: 0 / toplam yanıt: 1 · sayfa: "Request Rejected" · gövde: `The requested URL was rejected. Please consult with your administrator. Your support ID is: <9051587011699448911> [Go Back]`
...
### Endeks kapanışları — ✓ 87 endeks · veri günü 2026-09-07
- XKTUM 19550.77 · XKTMT 17601.23 · XK100 17946.36 · XU100 14151.59 · BISTTLREFK 4133.48105
- arşiv: 627 gün · dosyalar: bisttlrefkendeksi.csv(1), zip:[FiyatEndeksleri_PriceIndices.csv, GetiriEndeksleri_ReturnIndices.csv], FiyatEndeksleri_PriceIndices.csv(84), GetiriEndeksleri_ReturnIndices.csv(2)
...
### Model sicili serisi (§291) — ✓ 2026-09-07 · model %-0.399 / endeks %7.054

### Sektör ısı + rotasyon (§333) — ✓ 2026-09-07 · 15/15 sektör
- çapalar: 1G 2026-09-04 · 1H 2026-08-31 · 1A 2026-08-07 · 3A null
- XU100 (1G/1H/1A/3A): 0.99 · -1.27 · 2.7 · 4.91
- 3A lideri: XKMYA %28.85
- ⚠ çapa sapması: 3A hedef 2026-06-09 → 2026-05-26 (14 gün geride) — ufuk ATLANDI, damgalı değer korundu
...
- ALFAS:2026: fetch failed (2. kez) · ALKIM:2026: fetch failed (2. kez)
...
- sektör iskontosu: %-47.5 · borçluluk %25.3
- en iskontolu: %-86.6 · medyan %-54.8 · en primli %1032.2
...
- içerik: thb202609041.csv
- endeks izi: `thb202609041.csv → TARIH;ISLEM  KODU;BULTEN ADI;PAZAR GRUBU;PAZAR;YAPISAL BAZDA PIYASA ALT BOLUMU;ENSTRUMAN GRUBU;ENSTRUMAN TIPI;ENSTRUMAN SINIFI;ISLEM YONTEMI;PIYASA YAPICI;BIST 100 ENDEKS;BIST 30 ENDEKS;BRUT TAKAS;OZS`

### Bülten fiyat keşfi (§305 · tek koşuluk ölçüm) — thb202609041.csv
...
### Fon portföy dağılımı (§429) — ⏭ 0 rapor işlendi · evren 132 fon (oto +0) · depo 2 fon / 2 dönem · KAP yolu: tarama(132 fon, 16975 kayıt) · pencere 400 gün
...
- ⚠ hata: TLZ null: III-FON PORTFÖY DEĞERİ TABLOSU başlığı yok · KKC null: HİSSE SENETLERİ bölümü yok · KHJ null: III-FON PORTFÖY DEĞERİ TABLOSU başlığı yok · KLH null: III-FON PORTFÖY DEĞERİ TABLOSU başlığı yok · AL4 null: fetch failed …+33


---
**Sonuç:** XK100 ağırlıkları · XKTUM ağırlıkları · XKTMT ağırlıkları · Multiple fiyatları (130 fiyat) · Model sicili (38 fiyat) · TR 5Y CDS (218.68 bp) · fon akışı (2034) · katılım fonları (46+akış) · bilanço tetiği (68 bekliyor) · endeks üyelikleri · endeks arşivi · sicil serisi · sektör ısı (15 sektör) · küresel makro takvim (17 olay) · faktör evreni (101/247) · KAP arşivi (+0 çeyrek) · GYO NAV (45 şirket) · VAP fon akışı (8 ay)

### Süre bütçesi (§326)
- ⏱ Faktör evreni (§361) — 94 sn
- ⏱ KAP arşivi (§381) — 73 sn
- ⏱ Fon portföy dağılımı (§429) — 104 sn
- toplam: 323 sn