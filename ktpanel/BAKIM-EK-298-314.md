# BAKIM EK BLOGU — §298-§314 (17-18 Agu 2026)
# KTPANEL-BAKIM.md'ye bu haftanin deltasi olarak yapistirilir (en yeni ustte
# duzenine gore yerlestir). DAMGA guncellemeleri en altta ayri bolumde.
# Kaynak: Claude denetim/gelistirme oturumlari; her kayit OLCUMLE dogrulandi.
...
e (§311) → f (§312+§313). Canli dogrulanan: 20260818f oncesi d; e-f cifti
kullanici yuklemesinde. scripts/tazele.mjs zinciri: §291→297→299/300/301→
...
- §315 sukuk taktik sinyal karti (girdilerin tumu artik otomatik akiyor) ve
  §316 piyasa-imali PPK dagilimi dugmesi — siradaki insa
- ham_ozet penceresi: bir temiz V2.2 kosusu sonrasi muhurlenir
