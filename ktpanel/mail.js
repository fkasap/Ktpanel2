...
module.exports = async (req, res) => {
  ...
  if (cron) {
    ...
    if (tip === 'haftalik') {
      ...
      /* §252i ID UYUSMAZLIGI. Burada 'taktikselBody' ve 'taktiksel' araniyordu;
         index.html'de IKISI DE YOK — gercek id 'taktikBody2' (yedegi 'taktikBody').
         app.js:3279 dogrusunu biliyor: $('taktikBody2')||$('taktikBody').
         Sonuc: takVar hep false, TAKTIKSEL DAGILIM blogu maile HIC girmiyordu ve
         dipnot zarifce "panelde hesaplanir" deyip geciyordu — ariza gibi gorunmuyordu. */
      const takHtml = al('taktikBody2') || al('taktikBody');
